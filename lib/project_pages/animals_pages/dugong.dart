...
class DugongPage extends StatefulWidget {
  const DugongPage({super.key});

  @override
  State<DugongPage> createState() => _DugongPageState();
}

class _DugongPageState extends State<DugongPage> {
  List animalsResList = [];
        ...
        body: ListView(padding: const EdgeInsets.all(30), children: [
          Padding(
            ...
            child: Container(
                ...
                child:
                    const ImageUtility(imageName: AnimalsImagesPaths.dugong)),
          ),

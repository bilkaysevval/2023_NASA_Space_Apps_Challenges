...
class GiantMantaRayPage extends StatefulWidget {
  const GiantMantaRayPage({super.key});

  @override
  State<GiantMantaRayPage> createState() => _GiantMantaRayPageState();
}

class _GiantMantaRayPageState extends State<GiantMantaRayPage> {
  List animalsResList = [];
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.giantMantaRay,
            )),

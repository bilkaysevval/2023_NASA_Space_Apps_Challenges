...
class WhiteWhalePage extends StatefulWidget {
  const WhiteWhalePage({super.key});

  @override
  State<WhiteWhalePage> createState() => _WhiteWhalePageState();
}

class _WhiteWhalePageState extends State<WhiteWhalePage> {
  List animalsResList = [];

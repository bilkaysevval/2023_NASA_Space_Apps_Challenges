...
class HawaiianMonkSeaPage extends StatefulWidget {
  const HawaiianMonkSeaPage({super.key});

  @override
  State<HawaiianMonkSeaPage> createState() => _HawaiianMonkSeaPageState();
}

class _HawaiianMonkSeaPageState extends State<HawaiianMonkSeaPage> {
  List animalsResList = [];
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.hawaiianMonkSeal,
            )),

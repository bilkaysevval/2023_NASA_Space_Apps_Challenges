...
class MediterraneanMonkSealPage extends StatefulWidget {
  const MediterraneanMonkSealPage({super.key});

  @override
  State<MediterraneanMonkSealPage> createState() =>
      _MediterraneanMonkSealPageState();
}

class _MediterraneanMonkSealPageState extends State<MediterraneanMonkSealPage> {
  List animalsResList = [];
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.mediterraneanMonkSeal,
            )),

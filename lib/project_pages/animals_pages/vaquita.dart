...
class VaquitaPage extends StatefulWidget {
  const VaquitaPage({super.key});

  @override
  State<VaquitaPage> createState() => _VaquitaPageState();
}

class _VaquitaPageState extends State<VaquitaPage> {
  List animalsResList = [];
        ...
        body: ListView(padding: const EdgeInsets.all(30), children: [
          Padding(
            ...
            child: Container(
                ...
                child:
                    const ImageUtility(imageName: AnimalsImagesPaths.vaquita)),
          ),

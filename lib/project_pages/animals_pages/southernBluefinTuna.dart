...
class SouthernBluefinTunaPage extends StatefulWidget {
  const SouthernBluefinTunaPage({super.key});

  @override
  State<SouthernBluefinTunaPage> createState() =>
      _SouthernBluefinTunaPageState();
}

class _SouthernBluefinTunaPageState extends State<SouthernBluefinTunaPage> {
  List animalsResList = [];
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.bluefinTuna,
            )),

...
class StellerSeaLionPage extends StatefulWidget {
  const StellerSeaLionPage({super.key});

  @override
  State<StellerSeaLionPage> createState() => _StellerSeaLionPageState();
}

class _StellerSeaLionPageState extends State<StellerSeaLionPage> {
  List animalsResList = [];
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.stellerSeaLion,
            )),

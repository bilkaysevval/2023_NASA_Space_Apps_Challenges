...
class GreatWhiteSharkPage extends StatefulWidget {
  const GreatWhiteSharkPage({super.key});

  @override
  State<GreatWhiteSharkPage> createState() => _GreatWhiteSharkPageState();
}

class _GreatWhiteSharkPageState extends State<GreatWhiteSharkPage> {
  List animalsResList = [];
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.greatWhiteShark,
            )),

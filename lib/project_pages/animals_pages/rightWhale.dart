...
class RightWhalePage extends StatefulWidget {
  const RightWhalePage({super.key});

  @override
  State<RightWhalePage> createState() => _RightWhalePageState();
}

class _RightWhalePageState extends State<RightWhalePage> {
  List animalsResList = [];

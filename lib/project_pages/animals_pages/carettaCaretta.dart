...
class CarettaCarettaPage extends StatefulWidget {
  const CarettaCarettaPage({super.key});

  @override
  State<CarettaCarettaPage> createState() => _CarettaCarettaPageState();
}

class _CarettaCarettaPageState extends State<CarettaCarettaPage> {
  List animalsResList = [];
  @override
  void initState() {
    super.initState();
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
            ...
            child: const CustomAppBar(
              title: AnimalsNames.carettaCaretta,
            )),

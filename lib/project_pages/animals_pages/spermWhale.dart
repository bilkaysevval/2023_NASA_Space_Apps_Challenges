...
class SpermWhalePage extends StatefulWidget {
  const SpermWhalePage({super.key});

  @override
  State<SpermWhalePage> createState() => _SpermWhalePageState();
}

class _SpermWhalePageState extends State<SpermWhalePage> {
  List animalsResList = [];
